...
interface SelectProps extends React.HTMLProps<HTMLElement> {
  ...
  root: SelectRootProps<any, boolean>;
}

export default function KSelect({ values, root }: SelectProps) {
  return (
    <div className={styles.Field}>
      <Select.Root {...root} items={values}>
        <Select.Label className={styles.Label}>State</Select.Label>
